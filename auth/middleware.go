...
func FetchOrCreateUser(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		customClaims := claims.(*validator.ValidatedClaims).CustomClaims.(*middleware.CustomClaims) // Adjust based on how your claims are structured
...
func fetchUserByEmail(email string, user *User, db *gorm.DB) error {
